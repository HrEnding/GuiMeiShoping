...
<div class="layui-layout layui-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a target="iframe_context" href="/admin/showInfo?id=${admin.suId}">基本资料</a></dd>
            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context"  href="/custom/union?pageNumber=1">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context" href="/smallClass/query?pageNumber=1">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;商品管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="/goods/union">查询商品</a></dd>
                        <dd><a target="iframe_context" href="/goods/addGoodsPage">添加商品</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    <a target="iframe_context" class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe770;&nbsp;&nbsp;商家管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="/seller/union">查询商家</a></dd>
                        <dd><a target="iframe_context" href="/seller/turnToinsert">添加商家</a></dd>
                    </dl>
                </li>
    ...
    <div id="main" class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <iframe name="iframe_context" frameborder="0" id="context" src="/custom/union?num=1"  ></iframe>
        </div>
    </div>
